...
\begin{document}
	...
	Special examples:\\
	\indent -1, the script waits for the program to start.\\
	\indent 0, there is no wait time after executing this program.\\
	...
	\missingfigure{Screen of the automatic startup timer}	
	...
	\missingfigure{Screen of the default script setting}
	...
	\todo[inline]{Explanation of the shutdown buttons}
	...
	\missingfigure{a currently running program}
