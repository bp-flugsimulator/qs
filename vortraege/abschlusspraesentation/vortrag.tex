...
\pgfplotstableread[row sep=\\,col sep=&]{
    Iteration & Implementierung & Storypoints & Sonstiges\\
    1         & 1.2  & 40  & 0.2  \\
    2         & 12.8 & 18  & 4.9  \\
    3         & 15.5 & 50 & 13.4 \\
    4         & 0 & 0 & 0 \\
...
\begin{frame}
	...
	\node[inner sep=0] at (current page.center)
	{		\includegraphics[scale=0.23]{aufbau_gesamt}};
	 \node () [draw, rounded rectangle, yshift=-0.9cm, minimum height=1.3cm, minimum width=10cm] {};
	\end{tikzpicture}
...
\begin{frame}
	...
	\begin{figure}
			\begin{tikzpicture}
        		...
        		\addplot table[x=Iteration,y=Vorhergesagt]{\mydata};
    		\end{axis}
		\end{tikzpicture}
	\end{figure}
