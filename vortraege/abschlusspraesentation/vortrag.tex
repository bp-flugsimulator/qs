...
\begin{frame}
	...
	\begin{figure}
		\centering
		\vspace{-.5cm}
		\includegraphics[scale=0.048]{sim}
	\end{figure}
...
\begin{frame}
	...
	\begin{figure}
		\centering
		\vspace{-.4cm}
		\includegraphics[scale=0.032]{server}	
	\end{figure}
\end{frame}
...
\begin{frame}
	...
	\begin{figure}
		...
		\centering
		\only<1>{\includegraphics[scale=0.42]{1}}
		\only<2>{\includegraphics[scale=0.42]{2}}
		\only<3>{\includegraphics[scale=0.42]{3}}
		\only<4>{\includegraphics[scale=0.42]{4}}
		\only<5>{\includegraphics[scale=0.42]{6}}
		\end{overlayarea}
	\end{figure}
\end{frame}
