...
\Qitem[a]{ \Qq{Wie fanden Sie das Anlegen von Skripten?} \Qtab{3cm}{schwierig \Qrating{5} einfach}}
\Qitem[b]{Was könnte man verbessern?}

\emptybox{80pt}

\Qitem[c]{ \Qq{Wie fanden Sie das Ausführen von Skripten?} \Qtab{3cm}{schwierig \Qrating{5} einfach}}
\Qitem[d]{Was könnte man verbessern?}

\emptybox{80pt}

\Qitem[e]{ \Qq{Wie verständlich fanden Sie die Reihenfolge von Skriptteilen (Programs, Filesystem)?} \Qtab{3cm}{schwierig \Qrating{5} einfach}}
\Qitem[f]{Was könnte man verbessern?}

\emptybox{80pt}

\Qitem[g]{ \Qq{Wie fanden Sie die Fehleranzeige?} \Qtab{3cm}{eher unintuitiv \Qrating{5} eher intuitiv}}
\Qitem[h]{Was könnte man verbessern?}
