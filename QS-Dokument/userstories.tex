...
\begin{table}[htbp]
    \begin{minipage}{\linewidth}
        ...
        \begin{tabulary}{\textwidth}{|l|p{10cm}|} \hline
            ...
            Beschreibung& Wenn sich der User mithilfe eines Browsers mit dem Server verbindet wird eine Willkommensnachricht angezeigt \\\hline
            Akzeptanz &Nach dem Benutzer eine korrekten Anfrage an \texttt{\slash welcome} gibt der Server eine Webseite mit dem Inhalt ``welcome'' zurück\\\hline
...
\begin{table}[htbp]
    \begin{minipage}{\linewidth}
        ...
        \begin{tabulary}{\textwidth}{|l|p{10cm}|} \hline
            ...
            Akzeptanz &Nachdem der Benutzer den entsprechenden Knopf betätigt hat, wird der Client gestartet und der Benutzer über diesen Vorgang benachrichtigt. Dies kann nur geschehen wenn der Benutzer zuvor die richtige MAC Adresse dem Client zugewiesen hat.\\\hline
...
\begin{table}[htbp]
    \begin{minipage}{\linewidth}
        ...
        \begin{tabulary}{\textwidth}{|l|p{10cm}|} \hline
            ...
            Akzeptanz &Der Status wird korrekt angezeigt und wird aktualisiert, sobald sich der reale Status des Clients geändert hat. Falls der Client nicht mit dem Server verbunden ist wird dies entsprechend angezeigt.\\\hline
...
\begin{table}[htbp]
    \begin{minipage}{\linewidth}
        ...
        \begin{tabulary}{\textwidth}{|l|p{10cm}|} \hline
            ...
            Beschreibung&Als Benutzer will einen Client per Webinterface herunterfahren können, um dies nicht manuell tun zu müssen.\\\hline
...
\begin{table}[htbp]
    \begin{minipage}{\linewidth}
        ...
        \begin{tabulary}{\textwidth}{|l|p{10cm}|} \hline
            ...
            Beschreibung&Als Benutzer will ich die Möglichkeit haben, ein bereits registriertes Programm auf einem Client starten zu können. \\\hline
            Akzeptanz &Nachdem der Benutzer das Programm gestartet hat, in dem er den entsprechenden Knopf betätigt hat, wird der Startbefehl an den Client gesendet. Falls das Programm terminiert wird ein Status Code an das Webinterface gesendet. \\\hline
...
\begin{table}[htbp]
    \begin{minipage}{\linewidth}
        ...
        \begin{tabulary}{\textwidth}{|l|p{10cm}|} \hline
            ...
            Akzeptanz &Der Status des Programms ist aktuell, korrekt und wird im Webinterface angezeigt. Das Programm wird mit Grün markiert sofern das Programm läuft, Rot sofern das Programm einen Fehler hatte und nichts falls das Programm nicht läuft.\\\hline
            Story Points&4\\\hline
            Entwickler &Tim\\\hline
            Iteration &4\\\hline
            Stunden  &6\\\hline
...
\begin{table}[htbp]
    \begin{minipage}{\linewidth}
        ...
        \begin{tabulary}{\textwidth}{|l|p{10cm}|} \hline
            ...
            Beschreibung&Als Benutzer will ich die Möglichkeit haben, eine, auf dem Server registrierte Datei auf einem ebenfalls auf dem Server registrierten Client zu bewegen, damit ich einfach Konfigurationen austauschen kann. Auch soll es möglich sein, den Ausgangs Status wieder herstellen zu können.\\\hline
            Akzeptanz &Nachdem der Benutzer den entsprechenden Kopf betätigt hat, wird die Datei auf dem Client verschoben und der Benutzer wird über den Erfolg der Aktion benachrichtigt. Der Knopf ändert seine Beschreibung auf zurücksetzen. Sofern eine Datei bereits bewegt wurde und der Benutzer drückt auf den Zurücksetzen Knopf, wird die Datei wieder entfernt (sofern diese nicht in der Zwischenzeit manuell überschrieben worden ist). Falls am dem Zielort bereits eine Datei existiert wird diese separat gespeichert. Es ist nicht Mögliche die Aktion Datei bewegen auszuführen falls die Datei bereits bewegt worden ist. Das gleiche gilt für die Datei zurücksetzten Aktion.\\\hline
            Story Points&10\\\hline
...
\begin{table}[htbp]
    \begin{minipage}{\linewidth}
        ...
        \begin{tabulary}{\textwidth}{|l|p{10cm}|} \hline
            ...
            Beschreibung&Als Benutzer will ich die Möglichkeit haben eine Datei vom Server auf den Client zu übertragen, damit ich dies nicht per USB oder ähnliches erledigen muss.\\\hline
            ...
            Stunden  &-\\\hline
            Velocity &-\\\hline
            Bemerkung & Bevor diese Userstory durchgeführt werden konnte, haben die Auftraggeber sich gegen diese Funktionalität entschieden.Die Funktionalität wurde nicht eingebaut, da diese nicht vom Auftraggeber dringend gefordert war. Die Funktionalität wurde dennoch in einer anderen Variante bereitgestellt (in einer anderen Userstory). \\\hline
        \end{tabulary}
    \end{minipage}
\end{table}
...
\begin{table}[htbp]
    \begin{minipage}{\linewidth}
        ...
        \begin{tabulary}{\textwidth}{|l|p{10cm}|} \hline
            ...
            Beschreibung&Als Benutzer will ich die Möglichkeit haben eine Datei auf dem Client zu löschen, damit ich dies nicht per KVM-Switch erledigen muss.\\\hline
            Akzeptanz &Der Benutzer wird vor dem Löschen gewarnt und nach einer Bestätigung gefragt. Falls er diese erteilt wird die korrekte Datei auf dem Client permanent gelöscht.\\\hline
            Story Points&4\\\hline
            Entwickler &?\\\hline
            Iteration &?\\\hline
            Stunden  &?\\\hline
            Velocity &?\\\hline
            Bemerkung & Bevor diese Userstory durchgeführt werden konnte, haben die Auftraggeber sich gegen diese Funktionalität entschieden. Die Funktionalität wurde nicht eingebaut, da diese nicht vom Auftraggeber dringend gefordert war.\\\hline
        \end{tabulary}
    \end{minipage}
\end{table}
...
\begin{table}[htbp]
    \begin{minipage}{\linewidth}
        ...
        \begin{tabulary}{\textwidth}{|l|p{10cm}|} \hline
            ...
            Akzeptanz &Die Server Software wird gestartet und das Webbrowser Fenster öffnet sich mit der  Startseite.\\\hline
            Story Points&2\\\hline
            Entwickler &?\\\hline
            Iteration &?\\\hline
            Stunden  &?\\\hline
            Velocity &?\\\hline
            Bemerkung & Auf Wunsch der Auftraggeber wurde diese Funktion über die Autostartfunktionalität des Betriebssystems realisiert. Diese Funktion wurde dem Auftraggeber über einen anderen Weg bereitgestellt.\\\hline
        \end{tabulary}
    \end{minipage}
\end{table}
...
\begin{table}[htbp]
    \begin{minipage}{\linewidth}
        ...
        \begin{tabulary}{\textwidth}{|l|p{10cm}|} \hline
            ...
            Akzeptanz &Nachdem der Benutzer den entsprechenden Knopf betätigt hat, öffnet sich ein Dialog. In diesem Dialog muss der Benutzer den Löschvorgang bestätigen. Nach der Bestätigung ist der Client nicht mehr für den Benutzer im Webinterface zu sehen und wird aus der Datenbank entfernt. Falls der Benutzer die Aktion abbricht wird der Client nicht aus der Datenbank gelöscht und steht weiterhin zur verfügung.\\\hline
            Story Points&4\\\hline
